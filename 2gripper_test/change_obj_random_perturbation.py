    ...
    for i in range(1):
        ...
        if flag_1==True:
            for j in range(num_points):
                ...
                #逐渐减小机械臂的力，记录最小的夹取力
                min_froce=random_perturbation(flags,panda,object,object_pos_1,matrix_1,log_1,obj_id,scene_id,obj_key,center_of_mass)
                print(min_froce)
                #移除所有物体、机械臂、辅助线
                if object==-1:
                    p.removeBody(panda)
...
def carmer_photo(i,grasp_center,left_finger_target,right_finger_target,target_position):
    ...
    # 添加文字到左上角
    text_1 = f'{output_path}_{obj_key}_1.png'
    text_2 = f'{output_path}_{obj_key}_2.png' 
    ...
    image_pil_1.save(f'{output_path}_{obj_key}_1.png')
    image_pil_2.save(f'{output_path}_{obj_key}_2.png')
...
def random_perturbation(flags,panda,obj,object_pos_1,matrix_1,log_1,obj_id,scene_id,pose_num,center_of_mass):
    ...
    if flags==True:
        for i in range(10000):
            ...
            print(f"Actual force: {left_actual_force},{right_actual_force}")
            print(random_force)
