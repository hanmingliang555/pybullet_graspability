...
# 读取四个 Excel 文件
file_paths = [
    '3gripper_data/output/random_perturbation/origin.xlsx',
    '3gripper_data/output/random_perturbation/FC.xlsx',
    '3gripper_data/output/random_perturbation/FR.xlsx',
    '3gripper_data/output/random_perturbation/PAG.xlsx',
]
output_file='3gripper_data/output/random_perturbation/random_perturbation.xlsx'
