                    ...
                    while(i>0):
                        ...
                        if move_distance<distance and angle_value<angle:
                            ...
                            if match:
                                ...
                                # 取最大值
                                max_force.append(max(left_value, right_value,middle_value))
                                break
                        else :
                            i-=1
                    if i == 0:
...
# 读取四个 Excel 文件
file_paths = [
    '3gripper_data/output/decrease_force/origin.xlsx',
    '3gripper_data/output/decrease_force/FC.xlsx',
    '3gripper_data/output/decrease_force/FR.xlsx',
    '3gripper_data/output/decrease_force/PAG.xlsx',
]
output_file='3gripper_data/output/decrease_force/decrease_force.xlsx'
