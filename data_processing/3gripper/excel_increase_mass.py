                ...
                if "increase_mass" in file and file.endswith(".csv"): # 检查是否是 CSV 文件  
                    ...
                    if os.path.exists(standard_path_1) and os.path.exists(file_path):
                        ...
                        while(j>0):
                            ...
                            standard_move = standard_data[5]/friction
...
# 读取四个 Excel 文件
file_paths = [
    '3gripper_data/output/increase_mass/origin.xlsx',
    '3gripper_data/output/increase_mass/FC.xlsx',
    '3gripper_data/output/increase_mass/FR.xlsx',
    '3gripper_data/output/increase_mass/PAG.xlsx',
]
output_file='3gripper_data/output/increase_mass/increase_mass.xlsx'
